    ...
    public class CategoryController : ControllerBase {
		...
		public async Task<IActionResult> GetByIdAsync(
			...
			try {
				...
				return StatusCode(500, new ResultViewModel<List<Category>>("05X06 - Falha interna no servidor"));
			}
		}
			...
			[FromServices] BlogDataContext context)
		{
			...
			try {
				...
				return StatusCode(500, new ResultViewModel<List<Category>>("05XE8 - Não foi possível alterar a categoria"));
			}
